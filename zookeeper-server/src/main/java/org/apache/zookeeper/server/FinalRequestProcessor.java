    ...
    public void processRequest(Request request) {
        ...
        try {
            ...
            switch (request.type) {
                ...
                case OpCode.getData: {  //处理GetData请求
                    lastOp = "GETD";
                    ...
                    PrepRequestProcessor.checkACL(zks, request.cnxn, zks.getZKDatabase().aclForNode(n),ZooDefs.Perms.READ, request.authInfo, path, null);
                    Stat stat = new Stat();
                    //判断是否需要注册watch
